...
class Sun(Entity):
    ...
    def state_attributes(self):
        ...
        return {
            ...
            STATE_ATTR_DAYLIGHT: round(self.solar_daylight, 0),
...
# Approximates the above cloud lux for any location and point_in_time within 10%
#  Roughly based on http://www.domoticz.com/wiki/Real-time_solar_data_without_any_hardware_sensor_:_azimuth,_Altitude,_Lux_sensor...
